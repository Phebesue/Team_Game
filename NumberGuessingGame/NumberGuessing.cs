...
namespace NumberGuessingGame
{
    public class NumberGuessing
    {
        ...
        {
            string titleScreen = System.IO.File.ReadAllText(@"C:\ElevenFiftyProjects\Team_Game\NumberGuessingGame\TitleScreen.txt");
        ...
        {
            string win = System.IO.File.ReadAllText(@"C:\ElevenFiftyProjects\Team_Game\NumberGuessingGame\Win.txt");
                ...
                if (availableGuesses > 0)
                {
                    ...
                    else if (numberGuess <= 200 && numberGuess >= 5)
                    {
                        if (numberGuess > number)
                        {
                            ...
                            Console.WriteLine("Too High");
                            availableGuesses--;
                            //Commented out clues to increase difficulty
                            //if (numberGuess >= number + 15)
                            //{
                            //    Console.ForegroundColor = ConsoleColor.DarkGray;
                            //    Console.WriteLine("Way too high..");
